    ...
    return (
        <div className="items-center mx-2 lg:ml-36 w-full mt-10 max-w-sm overflow-hidden  rounded-lg shadow-lg dark:bg-gray-800">
            ...
            <div className="flex items-center px-6 py-3 bg-gray-900">
                <h1 className="mx-3 py-2 text-lg font-semibold text-white"><a href={link} className="relative px-6 py-3 font-bold text-white rounded-lg group" target='_blank' rel='noreferrer'>
            ...
            <div className="px-6 py-4">
                ...
                <p className="py-2  dark:text-gray-400">{details}</p>
