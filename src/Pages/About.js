...
const About = () => {
    return (
        <div>
            ...
            <div class="m-10 overflow-hidden relative">
                <img src="FB_IMG_1642859288462.jpg" class="w-96 h-96 block lg:hidden" alt='' />
                ...
                <div>
                    <img src="FB_IMG_1642859288462.jpg" class="absolute top-0 right-0 hidden h-full max-w-1/2 lg:block" />
                </div>
            </div>
